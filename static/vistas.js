...
function fsVantagePanelHTML(ctx, f) {
  ...
  let h = `<section class="panel"><h2><span class="tag-sec">VANTAGE POINT</span>Where the fund ranks vs its category — peer envelope</h2>`;
...
function fsScorecardHTML(f, ctx) {
  ...
  h += fsVantagePanelHTML(ctx, f);
  h += fsPortfolioHTML(f.portfolio);
